...
import { updateProduct, productStatus, addTask, updateTask, checkTask, delTask, findTask, searchProduct, savePerson, saveMileage, manageSearchTask, userFimdTask, searchMileage, bulkVerify, manageSearchProduct, searchManageUser } from "../service/ProjectApprovalService";
...
// 查找负责人
router.post("/searchManageUser", async (ctx) => {
    ctx.body = await searchManageUser(ctx.request.body);
});
